...
frightresult = open("alloc-right-Result.txt","w")
cnt = 0
for func1 in funcs1:
    if (("new" in func1 and func1.replace("new", "free") in funcs2) or ("alloc" in func1 and func1.replace("alloc", "free") in funcs2)):
