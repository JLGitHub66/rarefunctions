...
public interface CommonVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CommonParser#template_decl_start}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_start(CommonParser.Template_decl_startContext ctx);
	/**
	 * Visit a parse tree produced by {@link CommonParser#template_param_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_param_list(CommonParser.Template_param_listContext ctx);
	/**
