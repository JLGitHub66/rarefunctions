...
public interface FunctionVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitTemplate_decl(FunctionParser.Template_declContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_decl_param_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_param_list(FunctionParser.Template_decl_param_listContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_template}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_template(FunctionParser.Template_templateContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_decl_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_param(FunctionParser.Template_decl_paramContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_decl_keyword}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_keyword(FunctionParser.Template_decl_keywordContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_name(FunctionParser.Template_nameContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args(FunctionParser.Template_argsContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_args_param_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args_param_list(FunctionParser.Template_args_param_listContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#template_args_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args_param(FunctionParser.Template_args_paramContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRvalue_ref(FunctionParser.Rvalue_refContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionParser#class_key}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_key(FunctionParser.Class_keyContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGcc_attribute(FunctionParser.Gcc_attributeContext ctx);
	/**
