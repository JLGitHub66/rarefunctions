...
public interface ModuleVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitFunction_decl(ModuleParser.Function_declContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitParameter_ptrs(ModuleParser.Parameter_ptrsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDefault_parameter_value(ModuleParser.Default_parameter_valueContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTemplate_decl(ModuleParser.Template_declContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_decl_param_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_param_list(ModuleParser.Template_decl_param_listContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_template}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_template(ModuleParser.Template_templateContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_decl_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_param(ModuleParser.Template_decl_paramContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_decl_keyword}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_decl_keyword(ModuleParser.Template_decl_keywordContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_name(ModuleParser.Template_nameContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args(ModuleParser.Template_argsContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_args_param_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args_param_list(ModuleParser.Template_args_param_listContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#template_args_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTemplate_args_param(ModuleParser.Template_args_paramContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRvalue_ref(ModuleParser.Rvalue_refContext ctx);
	/**
	 * Visit a parse tree produced by {@link ModuleParser#class_key}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_key(ModuleParser.Class_keyContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGcc_attribute(ModuleParser.Gcc_attributeContext ctx);
	/**
