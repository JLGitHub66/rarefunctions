...
public interface CVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CParser#no_brackets}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_brackets(CParser.No_bracketsContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_brackets_curlies_or_squares}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_brackets_curlies_or_squares(CParser.No_brackets_curlies_or_squaresContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_brackets_or_semicolon}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_brackets_or_semicolon(CParser.No_brackets_or_semicolonContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_angle_brackets_or_brackets}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_angle_brackets_or_brackets(CParser.No_angle_brackets_or_bracketsContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_curlies}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_curlies(CParser.No_curliesContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_squares}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_squares(CParser.No_squaresContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_squares_or_semicolon}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_squares_or_semicolon(CParser.No_squares_or_semicolonContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#no_comma_or_semicolon}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNo_comma_or_semicolon(CParser.No_comma_or_semicolonContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#assign_water}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssign_water(CParser.Assign_waterContext ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#assign_water_l2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssign_water_l2(CParser.Assign_water_l2Context ctx);
	/**
	 * Visit a parse tree produced by {@link CParser#water}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWater(CParser.WaterContext ctx);
}