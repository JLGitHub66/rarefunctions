...
public class GenNormCFG {
    private String mPath;

    GenNormCFG(String path) {
        mPath = path;
    }
    ...
    public static void main(String[] args) throws IOException {
        String t = "/Users/hellomark/Documents/study/project/fuzzy2vec_mk/fuzzyc2cpg/TestExample/test";
        //Original address（hjj）:    String t = "D:\\Workspace\\RobustParser\\rp\\rp_c\\test1\\Workspace\\RobustParser\\rp";
        GenNormCFG c = new GenNormCFG(t);
        c.iterateAndDump();
    }
}
