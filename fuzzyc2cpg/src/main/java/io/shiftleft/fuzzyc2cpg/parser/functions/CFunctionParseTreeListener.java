...
public class CFunctionParseTreeListener extends FunctionBaseListener {
  ...
  @Override
  public void enterInstance(FunctionParser.InstanceContext ctx) {
    FunctionContentBuilder builder = (FunctionContentBuilder) p.builderStack
            .peek();
    builder.enterInstance(ctx);
  }

  @Override
  public void exitInstance(FunctionParser.InstanceContext ctx) {
    FunctionContentBuilder builder = (FunctionContentBuilder) p.builderStack
            .peek();
    builder.exitInstance(ctx);
  }
