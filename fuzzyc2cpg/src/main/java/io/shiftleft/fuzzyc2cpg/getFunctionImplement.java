...
public class getFunctionImplement {
    ...
    public static void main(String args[]) throws IOException {
        ...
        PrintStream ps = new PrintStream(path.substring(0,path.lastIndexOf(File.separator)) + File.separator + "project_FunctionImplement.out"); //输出流的文件名修改为.out文件
