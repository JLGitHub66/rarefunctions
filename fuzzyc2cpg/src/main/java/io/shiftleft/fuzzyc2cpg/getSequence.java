...
public class getSequence {
    ...
    public static void main(String args[]) throws IOException {
        ...
        String path = "D:\\其他系统\\test"; //test path 20220517
...
class AntlrParserDriverObserverNewTestNewForSequence implements AntlrParserDriverObserver {

    public List<AstNode> codeItems;

    public AntlrParserDriverObserverNewTestNewForSequence() {
