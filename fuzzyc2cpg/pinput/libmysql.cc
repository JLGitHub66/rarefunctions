  ...
  */
  switch (param->buffer_type) {
    ...
    case MYSQL_TYPE_TINY: {
      ...
      *param->error = (
  (( param->is_unsigned) ? (((data) > ( UINT_MAX8) || (data) < 0) ? 1 : 0) 
                 : (((data) > (
                                    INT_MAX8) || (data) < ( INT_MIN8)) ? 1 : 0)) ||
                       err > 0);
      *buffer = (uchar)data;
      break;
    }
    case MYSQL_TYPE_SHORT: {
      int err;
      longlong data = my_strtoll10(data, &endptr, &err);
      *param->error = (
  (( param->is_unsigned) ? (((data) > ( UINT_MAX16) || (data) < 0) ? 1 : 0) 
                 : (((data) > (
                                    INT_MAX16) || (data) < ( INT_MIN16)) ? 1 : 0)) ||
                       err > 0);
    ...
    case MYSQL_TYPE_LONG: {
      ...
      longlong data = my_strtoll10(data, &endptr, &err);
      *param->error = (
  (( param->is_unsigned) ? (((data) > ( UINT_MAX32) || (data) < 0) ? 1 : 0) 
                 : (((data) > (
                                    INT_MAX32) || (data) < ( INT_MIN32)) ? 1 : 0)) ||
                       err > 0);
    ...
    case MYSQL_TYPE_LONGLONG: {
      ...
      longlong data = my_strtoll10(data, &endptr, &err);
      *param->error =
          param-> param->is_unsigned ? err != 0 : (err > 0 || (err == 0 && data < 0));
    ...
    case MYSQL_TYPE_FLOAT: {
      int err;
      double data =
          my_strntod(&my_charset_latin1, data, length, &endptr, &err);
    ...
    case MYSQL_TYPE_TIME: {
      ...
      str_to_time(data, length, tm, &status);
    ...
    case MYSQL_TYPE_TIMESTAMP: {
      MYSQL_TIME_STATUS status;
      MYSQL_TIME *tm = (MYSQL_TIME *)buffer;
      (void)str_to_datetime(data, length, tm, TIME_FUZZY_DATE, &status);
      *param->error =
...
static void fetch_long_with_conversion(MYSQL_BIND *param, MYSQL_FIELD *field,
                                       longlong data, bool  param->is_unsigned) {
  uchar *buffer = pointer_cast<uchar *>(param->buffer);
  ...
  switch (param->buffer_type) {
    ...
    case MYSQL_TYPE_TINY:
      *param->error = 
  (( param->is_unsigned) ? (((value) > ( UINT_MAX8) || (value) < 0) ? 1 : 0) 
                 : (((value) > (
                                   INT_MAX8) || (value) < ( INT_MIN8)) ? 1 : 0));
      *(uchar *)param->buffer = (uchar)value;
      break;
    case MYSQL_TYPE_SHORT:
      *param->error = 
  (( param->is_unsigned) ? (((value) > ( UINT_MAX16) || (value) < 0) ? 1 : 0) 
                 : (((value) > (
                                   INT_MAX16) || (value) < ( INT_MIN16)) ? 1 : 0));
      shortstore(buffer, (short)value);
      break;
    case MYSQL_TYPE_LONG:
      *param->error = 
  (( param->is_unsigned) ? (((value) > ( UINT_MAX32) || (value) < 0) ? 1 : 0) 
                 : (((value) > (
                                   INT_MAX32) || (value) < ( INT_MIN32)) ? 1 : 0));
      longstore(buffer, (int32)value);
      break;
    case MYSQL_TYPE_LONGLONG:
      longlongstore(buffer, value);
      *param->error = param-> param->is_unsigned !=  param->is_unsigned && value < 0;
      break;
    case MYSQL_TYPE_FLOAT: {
      /*
...
static void fetch_float_with_conversion(MYSQL_BIND *param, MYSQL_FIELD *field,
  ...
  switch (param->buffer_type) {
    ...
    case MYSQL_TYPE_TINY:
      ...
      *param->error = val64 != (param-> param->is_unsigned ? (double)((uint8)*buffer)
                                                   : (double)((int8)*buffer));
      break;
    case MYSQL_TYPE_SHORT:
      if (param-> param->is_unsigned) {
      ...
      *param->error =
          val64 != (param-> param->is_unsigned ? (double)(*(ushort *)buffer)
                                       : (double)(*(short *)buffer));
      break;
    case MYSQL_TYPE_LONG:
      if (param-> param->is_unsigned) {
      ...
      *param->error =
          val64 != (param-> param->is_unsigned ? (double)(*(uint32 *)buffer)
                                       : (double)(*(int32 *)buffer));
      break;
    case MYSQL_TYPE_LONGLONG:
      if (param-> param->is_unsigned) {
      ...
      *param->error =
          val64 != (param-> param->is_unsigned ? ulonglong2double(*(ulonglong *)buffer)
...
static void fetch_result_tinyint(MYSQL_BIND *param, MYSQL_FIELD *field,
  ...
  *param->error = param-> param->is_unsigned != field_is_unsigned && data > INT_MAX8;
  (*row)++;
}
...
static void fetch_result_short(MYSQL_BIND *param, MYSQL_FIELD *field,
  ...
  *param->error = param-> param->is_unsigned != field_is_unsigned && data > INT_MAX16;
  *row += 2;
}
...
static void fetch_result_int32(MYSQL_BIND *param,
  ...
  *param->error = param-> param->is_unsigned != field_is_unsigned && data > INT_MAX32;
  *row += 4;
}
...
static void fetch_result_int64(MYSQL_BIND *param,
  ...
  *param->error = param-> param->is_unsigned != field_is_unsigned && data > LLONG_MAX;
